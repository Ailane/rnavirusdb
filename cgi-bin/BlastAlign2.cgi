...
my $command =  "perl BlastAlign -i $file_location -r UserQuery -m 0.5"; 
   ...
   print header,
    ...
    print "<li><a href=\"/rnavirusdb/tmp$lib_loc.phy\">Alignment.phy</a>(Phylip format)<p>";
    print "<li><a href=\"/rnavirusdb/tmp$lib_loc.nxs\">Alignment.nxs</a>(Nexus format)<p><hr><p>";
